...
\singlespacing
\clearpage \bookmark[level=0, dest=toc_label]{TABLE OF CONTENTS}
\hypertarget{toc_label} \tableofcontents
\newpage \phantomsection \label{listoffig} \addcontentsline{toc}{chapter}{LIST OF FIGURES} 
\listoffigures
\newpage \phantomsection \label{listoftab} \addcontentsline{toc}{chapter}{LIST OF TABLES} \listoftables
\setstretch{\doublestretch}
\newpage 
\pagenumbering{arabic}\include{Introduction/Introduction}
