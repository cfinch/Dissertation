...
and 5\% \ce{CO2} for seven days. Phase-contrast microscopy images
...
\begin{figure}
\subfloat[\label{fig:CFD GO DETA near surf conc}DETA]{\includegraphics{Protein_Adsorption/Plots/CFD_GO_DETA_near_surf_conc}

}\subfloat[\label{fig:CFD GO 13F near surf conc}13F]{\includegraphics{Protein_Adsorption/Plots/CFD_GO_13F_near_surf_conc}



}

\subfloat[\label{fig:CFD GO glass near surf conc}Glass]{\includegraphics{Protein_Adsorption/Plots/CFD_GO_glass_near_surf_conc}
...
}\includegraphics{Protein_Adsorption/Plots/CFD_surf_conc_legend}\caption{\label{fig:CFD GO surface density}Surface density of adsorbed protein
...
%
\begin{figure}
\includegraphics{Protein_Adsorption/Plots/FN_13F_RSA_CFD}
